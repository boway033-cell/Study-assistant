...
const routes = [
  ...
  { path: '/literature-workbench', name: 'literature-workbench', component: () => import('../views/LiteratureWorkbenchView.vue'), meta: { title: '文献汇报', context: '获取 · 选证 · 输出' } },
  { path: '/writing', name: 'writing', component: () => import('../views/WritingView.vue'), meta: { title: '写作工作台', context: '研究写作 · 公文写作' } },
