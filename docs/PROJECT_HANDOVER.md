...
> **最后更新**：Writing DNA 写作实验室、DOCX 白名单去 AI 味、分场景字体设计系统与大库性能收口
...
### 文献工作台写作实验室（2026-08-28）

- 工作台命令栏进入“写作实验室”，不新增顶层页面。Writing DNA 项目强制选择至少 20 篇已完成解析且正文不少于 500 字的完整文章，并要求用户确认语料处理权利。
