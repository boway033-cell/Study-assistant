...
> **最后更新**：功能区块重构、独立写作台、沉浸阅读、知识库健康检查与知识对象强制取材
...
- 仓库：https://github.com/boway033-cell/Study-assistant（分支 main，当前发布版本 v2.0.0）
...
git tag v2.0.0 && git push origin v2.0.0  # 触发 Release 自动打包
