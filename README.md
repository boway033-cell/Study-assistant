...
| AI 问答 | ✅ 完成 | RAG 检索 + DeepSeek 云端流式回答，答案带出处页码；右侧原文面板；flash/pro 切换 |
| 知识树 | ✅ 完成 | 自主搭建知识树、拖拽调整、关联教材章节右侧看原文、节点笔记 |
| 刷题自测 | ✅ 完成 | 选择/填空/简答，自动判分 + 自评，错题本 |
| 学习统计 | ✅ 完成 | 总览、章节掌握度（基于作答）、作答趋势、薄弱章节排行 |
| 设置 | ✅ 完成 | DeepSeek API Key、flash/pro 模型切换、连接探测 |

**测试情况**：单元测试 34/34 通过 · Playwright 浏览器 UI 测试（资料库/搜索/知识树/刷题/统计/设置/问答）。
